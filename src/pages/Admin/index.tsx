...
const microApps = [
  {
    ...
    entry: process.env.NODE_ENV === 'development' ? 'http://localhost:3002/' : '/security-management/',
    container: '#qiankun-container',
    // activeRule: '/security-management/admin/security/component',
    activeRule: (location: any) => location.pathname?.startsWith('/jupiter/pages'), // 主框架的路由前缀'/app' + 微应用的页面访问路由
